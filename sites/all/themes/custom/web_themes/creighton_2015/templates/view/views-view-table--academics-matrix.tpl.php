 ...
 *
 */
  drupal_add_css(drupal_get_path('theme', 'creighton_2015') . '/css/matrix/tablesaw.css');
  drupal_add_js(drupal_get_path('theme', 'creighton_2015') .'/js/vendor/tablesaw.stackonly.js');
  drupal_add_js(drupal_get_path('theme', 'creighton_2015') .'/js/matrix.js');
?>
...
<script>
//  var tableWidth = jQuery(".tablesaw-stack").width();
//  window.setInterval(stickyHeadResize, 200);
//  function stickyHeadResize() {
//    if (jQuery(".stickynav-active").css("width") != tableWidth + "px") {
//      var newTableWidth = jQuery(".tablesaw-stack").width();
//      jQuery(".stickynav-active").css("width",newTableWidth);
//    }
//  }

//  jQuery(".stickynav-active").css("width",tableWidth);
</script>
