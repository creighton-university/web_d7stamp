...
//Active  = 1
//Off     = 0
if (isset($content['field_header_alert_activate']['#items'][0]['value'])) {
...
if (isset($content['field_emergency_type']['#items'][0]['value'])) {
  $emergencyType  = $content['field_emergency_type']['#items'][0]['value'];
}
if (isset($content['field_emergency_headline']['#items'][0]['value'])) {
...
if (isset($content['field_header_alert_markup']['#items'][0]['value'])) {
    $headerContent = $content['field_header_alert_markup']['#items'][0]['value'];
}
if (isset($content['field_header_alert_link']['#items'][0]['url'])) {
    ...
    <div class="container">
      ...
      <div id="alert-content">
        ...
        if(isset($headerLink) && $headerLink != ''){
          ?> <a id="alert-info" href="<?php print $headerLink; ?>">More Information</a> <?php          
        }
        ?>              
      </div>
    </div>
