...
<head>
  ...
  <?php print $scripts; ?>
  <script src="<?php echo $absolute_theme_url; ?>/js/vendor/modernizr.js"></script>
...
<!-- End Google Tag Manager -->
  ...
  <?php print $page_top; ?>
  <?php print $page; ?>
 <?php //print $page['#views_contextual_links_info']['views_ui']['view']->result[0]->field_faculty_admin_roles_ldrshp[0]->Activity Type->#title; ?>
