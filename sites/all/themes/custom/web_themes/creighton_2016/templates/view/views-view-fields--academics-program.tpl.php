...
<?php if( isset($fields['field_pgm_dts_tab_learn']->content) ||
  ...
  <div class="block--tab-acc accordion">
    ...
    <?php endif; ?>
    <?php if( isset($fields['field_tab_custom']->content) ) : ?>
        <?php print render($fields['field_tab_custom']->content); ?>
    <?php endif; ?>
    <?php if( isset($fields['field_tab_custom_2']->content) ) : ?>
      <?php print render($fields['field_tab_custom_2']->content); ?>
    <?php endif; ?>
    <?php if( isset($fields['field_tab_custom_3']->content) ) : ?>
      <?php print render($fields['field_tab_custom_3']->content); ?>
    <?php endif; ?>
    <?php if( isset($fields['field_tab_custom_all']->content) ) : ?>
      <?php print render($fields['field_tab_custom_all']->content); ?>
    <?php endif; ?>
  </div>
<?php endif; ?>
