...
<?php
  ...
  if(isset($content['field_profile_name']['#items'])){
    $profile_name = $content['field_profile_name']['#items'][0]['safe'];
  }
...
<div class="block--profile sidebar-item quote-pi">
  ...
  <?php if($quote == '1'): ?>
    <blockquote><q><?php $profile_body; ?></q></blockquote>
  <?php else: ?>
    <p><?php $profile_body; ?></p>
  <?php endif; ?>
