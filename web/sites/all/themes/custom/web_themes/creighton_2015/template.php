 ...
 * Creighton University 2015 theme.
 */
function creighton_2015_preprocess_html(&$variables) {
...
function creighton_2015_omega_layout_alter(&$layout){
   
  if(drupal_is_front_page()){
    $layout = "cu-front-2015";
  }
}
function creighton_2015_template_preprocess(&$variables, $hook) {
  global $style_type;
}
/**
 * Implements hook_theme().
 */
function creighton_2015_theme() {
  $items = array();
  // create custom user-login.tpl.php
  $items['user_login'] = array(
  'render element' => 'form',
  'path' => drupal_get_path('theme', 'creighton_2015') . '/templates/user',
  'template' => 'user-login',
  'preprocess functions' => array(
  'creighton_2015_preprocess_user_login'
  ),
    	'user_register' => array(
 ...
 */
function creighton_2015_preprocess_page(&$variables)
{
    global $user;
 ...
 */
function creighton_2015_preprocess_panels_pane(&$vars) {
