  ...
  <div class="l-main" role="main">
    <div class="container">
      ...
      <div class="content-body l-content">
        ...
        <?php if(!empty($node->field_main_large_horiz_image)) : ?>
            <div class="main_large_horiz_image">
            <?php
                $horiz_image_url = file_create_url($node->field_main_large_horiz_image['und'][0]['uri']);
                $horiz_image_alt = $node->field_main_large_horiz_image['und'][0]['alt'];
                print("<img src='" . $horiz_image_url . "' alt='" . $horiz_image_alt . "'>");
                ?>
            </div>
        <?php endif; ?>
