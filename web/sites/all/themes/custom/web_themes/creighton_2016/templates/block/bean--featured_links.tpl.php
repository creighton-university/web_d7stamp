...
<?php
  ...
  //Internal Links
  if(!empty($content['field_link_type']) && $content['field_link_type']['#items'][0]['value'] == 1) {   
...
//     print '<a href="' . $uri . '" class="' . $btn_color . '">' . $link_text . '</a>';
  ...
  elseif(!empty($content['field_link_type']) && $content['field_link_type']['#items'][0]['value'] == 2) {
...
//     print '<a href="' . $uri . '" target="_blank" class="' . $btn_color . '" rel="nofollow">' . $link_text . '</a>';
  ...
  elseif(!empty($content['field_link_type']) && $content['field_link_type']['#items'][0]['value'] == 3) {
