 ...
 */
?>
<div role="navigation" class="<?php print $classes; ?>">
  <div class="mobile-main-menu-footer <?php print $classes; ?>">
    <a href="#" class="fp-dropdown-links">
      <span class="mobile-accordion">Select from Main Menu</span>
    </a>
