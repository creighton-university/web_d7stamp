  ...
  <h4><?php print $fullname ?></h4>
	 ...
	 if (!empty($leadership_array)) { ?>
		 ...
		 <?php if ($lead_array_size > $leader_num) { ?>
			 <p class="see-more"><a href="<?php print '/faculty-directory-profile/' . $row->nid . '/' . $nameUrl; ?>">see more...</a></p>
		 <?php } ?>
	 <?php } ?>
	 ...
	 <?php if (!empty($row->specializations)) { ?>
		<div class="profile-specialties">
			...
			<?php if(count($specialization_array) > $special_num) { ?>
