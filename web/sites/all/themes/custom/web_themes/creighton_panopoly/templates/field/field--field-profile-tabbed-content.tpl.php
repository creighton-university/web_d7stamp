<?php
  ...
  foreach ($items as $delta => $item) {
    ...
    array_push($content_title, $item['entity']['field_collection_item'][$cur_fc_key]['field_profile_tabbed_title'][0]['#markup']);
    array_push($content_body, $item['entity']['field_collection_item'][$cur_fc_key]['field_profile_tabbed_body'][0]['#markup']);
  }
?>
<?php // Tabs markup ?>
<div class="item-list">
