...
<div id="advanced-search" class="clearfix">
  <fieldset id="school-filter">
    ...
    <div class="col-1">
      <div>
        <input type="radio"  name="school-filter" id="school-ccas" value="Art & Sciences">
      ...
      <div>
        <input type="radio"  name="school-filter" id="school-con" value="Nursing">
        <label for="school-con" >College of Nursing</label>
      </div>
      <div>
        <input type="radio"  name="school-filter" id="school-cps" value="GAPS">
    ...
    <div class="col-2">
      ...
      <div>
        <input type="radio"  name="school-filter" id="school-sod" value="Dentistry">
        <label for="school-sod" >School of Dentistry</label>
      </div>
      <div>
        <input type="radio"  name="school-filter" id="school-sol" value="Law School">
        <label for="school-sol" >School of Law</label>
      </div>
      <div>
        <input type="radio"  name="school-filter" id="school-som" value="Medicine">
        <label for="school-som" >School of Medicine</label>
      </div>
    </div>
    <div class="col-3">
      <div>
        <input type="radio" name="school-filter" id="school-sop" value="Pharmacy & Health Professions">
...
<div id="alpha-foot">
  <p>For any updates or corrections to this page, please contact Xxxxxx Xxxxxxx.</p>
  <hr id="reset">
</div>
